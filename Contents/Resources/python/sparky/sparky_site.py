...
def standard_menu_entries():
  ...
  nmrfam_menu = (
    ...
    ('ab', 'Assign the best by Pine',   ('pineassign', 'best_assign')),
    ('se', 'Select all floating labels',('pineassign','select_all_float_labels')),
    ('ep', 'Export to PINE input file', ('pineassign', 'export_pine')),
	('cy', 'Cyana2Sparky format',       ('readcyana','read_cyana_peak_list')),
    ('ta', 'Transfer assignment to NOESY', ('tan','TAN')),
    ('up', 'Update Ponderosa', ('connect_ponderosa', 'connect_ponderosa_analyzer')),
    )
